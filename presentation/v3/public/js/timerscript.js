...
function CountBack(round_mafia)
{
    ...
    for( var i = 0; i < round_mafia; i++ )
    {
        ...
        if(document.getElementById('endroundspanid_1'))
           document.getElementById('endroundspanid_1').innerHTML = DisplayStr;
        if(document.getElementById('endroundspanid_turbo_1'))
            document.getElementById('endroundspanid_turbo_1').innerHTML = DisplayStr;
        document.getElementById('timehid_1').value =  dnow + 1;
...
function CountBackWeb(round_mafia)
{
    ...
    for( var i = 0; i < round_mafia; i++ )
    {
        var dnow = Math.ceil(document.getElementById('web_timehid_'+i).value);     
        var round_mafia_ends = Math.ceil(document.getElementById('web_round_mafia_ends_'+i).value);
        var difference = round_mafia_ends-dnow;
        ...
        if(document.getElementById('web_endroundspanid_'+i))
           document.getElementById('web_endroundspanid_'+i).innerHTML = DisplayStr;
        if(document.getElementById('web_endroundspanid_turbo_'+i))
            document.getElementById('web_endroundspanid_turbo_'+i).innerHTML = DisplayStr;
        document.getElementById('web_timehid_'+i).value =  dnow + 1;
    }
...
setInterval("CountBackWeb(round_mafia)", 1000);
