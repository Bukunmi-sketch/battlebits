...
<body>
            ...
            <div class="login-box">
                ...
                <div class="form-subhdr">
                    <div class="dontaccount">DON'T HAVE AN ACCOUNT? <br>
                        <a href="signup">ENTER REGISTERED EMAIL ADDRESS</a>
                    </div>
                </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-sm-12 col-xs-12">
                                <div class="login-agree">
                                    <div class="cant-access"><a href="lostpass.php">Enter your email address to continue</a></div>
    ...
    btn.onclick = () => {
        ...
        xhr.open("POST", "./Controllers/forgetController.php", true);
